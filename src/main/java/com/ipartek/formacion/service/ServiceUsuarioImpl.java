...
public class ServiceUsuarioImpl implements ServiceUsuario {
  ...
  public Usuario lanzarDado() {
    ArrayList<Usuario> usuariosAlta = (ArrayList<Usuario>) this.daoUsuario.getAllUsuariosDeAlta();
    ...
    int n = (int) aleatorio;
    this.LOG.info("Numero aleatorio");
